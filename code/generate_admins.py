...
TOTAL_ADMINS = 350  # Μπορείς να το αλλάξεις ανάλογα με το πόσους χρειάζεσαι
...
for _ in range(TOTAL_ADMINS):
    ...
    # Δημιουργία της κλήσης της συνάρτησης insert_administrative_personnel
    sql = (
        f"SELECT insert_administrative_personnel("
...
with open("insert_admin_data.sql", "w", encoding="utf-8") as f:
    for stmt in sql_statements:
        f.write(stmt + "\n")

print(f"Επιτυχής δημιουργία! Τα δεδομένα αποθηκεύτηκαν στο αρχείο 'insert_admin_data.sql'.")